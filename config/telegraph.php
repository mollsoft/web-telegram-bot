...
return [
     ...
     * Back message prefix
     */
    'back_message_prefix' => ['⬅️', '🔙'],

    /*
     * Live page refresh rate (in seconds)
     */
    'live_frequency' => 10,

    /*
     * Chat information caching time (in seconds)
     */
    'chat_info_frequency' => 3600,
     ...
     */
    'webhook_handler' => \Mollsoft\WebTelegramBot\WebhookHandler::class,
     ...
     */
    'models' => [
        'bot' => \Mollsoft\WebTelegramBot\Models\TelegraphBot::class,
        'chat' => \Mollsoft\WebTelegramBot\Models\TelegraphChat::class,
    ],
