...
use Mollsoft\WebTelegramBot\Exceptions\RedirectException;
...
class Form
{
    ...
    protected function changeCurrent(string $current, array $extra = []): void
    {
        ...
        throw new RedirectException(
            to_route(Route::currentRouteName(), [
    ...
    public function parseInput(string $attribute, Request $request): ?string
    {
        return $request->message()?->text() ?? $request->callbackQuery()?->data()->get('value');
    }
